...
// к DM о таймауте (не о бане, см. ниже) и открывает модалку создания
// тикета темы "appeal" прямо из личных сообщений. Это единственный способ
// обжаловать наказание для участника в таймауте: пока действует нативный
// таймаут Discord, участник не может нажать НИКАКУЮ кнопку и не может
// использовать НИКАКУЮ слэш-команду на самом сервере (ограничение
// платформы, не бота) — а DM-взаимодействия с ботом этим не ограничены.
// Обработка клика — tickets/handlers.js handleAppealDmButton.
