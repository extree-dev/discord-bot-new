...
const CANNED_RESPONSES = {
    ...
    bug_confirmed: {
        ...
        text: 'Баг подтверждён и передан разработчикам. Спасибо за репорт! Как исправят — сообщим здесь.',
    },
    ...
    security_password: {
        label: 'Рекомендация по безопасности',
        text: 'Рекомендуем сменить пароль от аккаунта Discord и включить двухфакторную аутентификацию (2FA), если она ещё не включена.',
    },
    closing_soon: {
