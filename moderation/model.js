...
// апелляцию на само наказание в обычном порядке.
//
...
// участник по-прежнему может открыть панель обращений (scripts/setup-
// tickets.js) и отправить форму апелляции — она не тред и не требует
// SendMessages, всё взаимодействие целиком в кнопке и модалке.
